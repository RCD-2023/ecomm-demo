...
export const createOrder = async () => {
  try {
    ...
    //Create a transaction to created order and order items, in database
...
// Get sales data and order summary (Admin)
type SalesDataType = {
  month: string;
  totalSales: number;
}[];
...
//Update payments method action to COD (cash on delivery)
